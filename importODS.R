...
get_col_types_fnc("siteid, date_time, no2", df)
...
datehelper_fnc <- function(dateon, dateoff){
  ...
  dates_chr <- c("dateon" = dateon, "dateoff" = dateoff)
  dates_vec <- parse_date_time2(dates_chr, orders = c("Ymd", "dmY", "YmdHMS", "dmYHMS", "YmdHM", "dmYHM", "Y", "mY"))
...
datehelper_fnc(dateon = "2021", dateoff = "2022")  
...
# out <- getODSAggregate(select_str, where_str, groupby_str, dataset)
>>>>>>> 1a4719187b2c146a1bb75df227dd2a737914d8de
